    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <form action="confirmar_editar/aceptar_editarproducto_costos.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            <label for="descripcion">Mayor:</label>
                            <input name="costoformMayor" type="number" class="form-control" step="0.01" placeholder="Costo Mayor" value="<?php echo $fila['costomayor']; ?>">
                        </div>
                        <div class="col-sm-6">
                            <label for="descripcion">Menor:</label>
                            <input name="costoformMenor" type="number" class="form-control" step="0.01" placeholder="Costo Menor" value="<?php echo $fila['costomenor']; ?>">
                        </div>
                    ...
                    <a href="../listar/listar_producto_costos.php"><button type="button" class="btn btn-danger">Cancelar</button></a>
                </form>
            </div>
        </div>
    </div>
