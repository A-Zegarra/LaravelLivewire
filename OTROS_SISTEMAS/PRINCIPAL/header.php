                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="/listar/listar_producto_costos.php">Precios manuales</a></li>
                            <li><a class="dropdown-item" href="/listar/listar_producto.php">Precios sistema</a></li>
