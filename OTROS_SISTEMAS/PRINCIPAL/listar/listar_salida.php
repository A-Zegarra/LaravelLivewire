...
INNER JOIN producto ON salida.idproducto = producto.idproducto ORDER BY salida.idsalida ASC LIMIT $registros_por_pagina OFFSET $offset";
$resultado = $conn->query($sql);
$sql_total = "SELECT COUNT(*) as total_registros FROM salida";
...
<body>
            ...
            <table id="tabla-listas" class="table table-bordered table-striped mx-auto">
                ...
                <tbody>
                    ...
                    while ($fila = $resultado->fetch_assoc()) {
                        $idsalida = $fila['idsalida'];
                        $descripcion = $fila['descripcion'];
                        $cantidad = $fila['cantidad'];
                        $fecha = $fila['fecha'];
                    ?>
                        <tr>
                            <td><?php echo $idsalida; ?></td>
                            <td><?php echo $descripcion; ?></td>
                            <td><?php echo $cantidad; ?></td>
                            <td><?php echo $fecha; ?></td>
                            <td class="text-center"><a href="../editar/editar_salida.php?id=<?php echo $idsalida; ?>" class="btn btn-primary">Editar</a></td>
                            <td class="text-center"><a href="#" class="btn btn-danger" data-id="<?php echo $idsalida; ?>">Eliminar</a></td>
                        </tr>
                    <?php
                    }
                    ?>
    ...
    <script src="../js/eliminar_salida.js"></script>
