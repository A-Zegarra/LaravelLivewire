...
$sql = "SELECT
            ...
            p.costomenor,
            p.costomayor,
            IFNULL(SUM(i.cantidad), 0) AS cantidad_ingreso,
            IFNULL(SUM(s.cantidad), 0) AS cantidad_salida,
            (IFNULL(SUM(i.cantidad), 0) - IFNULL(SUM(s.cantidad), 0)) AS total_stock
        FROM
            producto p
        LEFT JOIN
    ...
    <div class="container">
        ...
        <nav class="navbar navbar-light bg-light">
            <div class="container-fluid">
                <form class='d-flex' action="../buscar/buscar_inventario.php" method="get">
            ...
            <table id="tabla-listas" class="table table-bordered table-striped mx-auto">
                ...
                <tbody>
                    ...
                    while ($fila = $resultado->fetch_assoc()) {
                        ...
                        $costomenor = round($fila['costomenor']);
                        $costomayor = round($fila['costomayor']);
                    ?>
                        <tr>
